...
-keep class com.rideincab.driver.home.firebaseChat.FirebaseChatModelClass{ *; }
-keep class com.rideincab.driver.home.datamodel.** { *; }
-keep class com.rideincab.driver.trips.voip.CabmeSinchService.** { *; }
-keep class com.rideincab.driver.home.map.FetchAddressIntentService{ *; }
-keep class com.rideincab.driver.home.map.AppUtils{ *; }
-keep class com.rideincab.driver.home.map.drawpolyline.** { *; }
-keep class com.rideincab.driver.home.map.**   { *; }
-keep class com.rideincab.driver.common.**  { *; }
-keep class com.rideincab.driver.trips.tripsdetails.** { *; }
-keep class com.rideincab.driver.google.direction.** { *; }
-keep class com.rideincab.driver.common.util.userchoice.** { *; }
-keep class com.rideincab.driver.common.model.** { *; }
-keep class com.rideincab.driver.home.payouts.payout_model_classed.** { *; }
