...
import com.rideincab.driver.common.util.Enums.REQ_PAST_TRIPS
...
import com.rideincab.driver.databinding.ActivityPastBinding
...
class CompletedTripsFragments : Fragment(), ServiceListener, PaginationAdapterCallback {
    ...
    lateinit var binding.pastRecyclerView: RecyclerView*/
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding = ActivityPastBinding.inflate(inflater, container, false)
//        binding.root.applySystemBarsPadding()
        ...
        if ("1" == laydir) {
            binding.pastRecyclerView.rotationY = 180f
            binding.listempty.rotationY = 180f
        }
        ...
        binding.pastRecyclerView.layoutManager = linearLayoutManager
        binding.pastRecyclerView.itemAnimator = DefaultItemAnimator()

        binding.pastRecyclerView.adapter = adapter
        val resId = R.anim.layout_animation_bottom_up
        val animation = AnimationUtils.loadLayoutAnimation(context, resId)
        binding.pastRecyclerView.layoutAnimation = animation

        binding.pastRecyclerView.addOnScrollListener(object : PaginationScrollListener(linearLayoutManager) {
    ...
    private fun onSuccessRiderProfile(jsonResp: JsonResponse) {
        ...
        if (CommonKeys.TripStatus.Scheduled == tripStatus || CommonKeys.TripStatus.Begin_Trip == tripStatus || CommonKeys.TripStatus.End_Trip == tripStatus) {
            ...
            //binding.pastRecyclerView.addOnItemTouchListener(this);
        } else if (CommonKeys.TripStatus.Rating == tripStatus) {
