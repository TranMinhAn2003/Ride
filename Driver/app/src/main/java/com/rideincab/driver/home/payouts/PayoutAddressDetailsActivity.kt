...
import com.rideincab.driver.databinding.ActivityPayoutAddressDetailsBinding
import com.rideincab.driver.databinding.LocationSearchBinding
...
class PayoutAddressDetailsActivity : CommonActivity(), View.OnClickListener, ServiceListener, UserChoiceSuccessResponse {
    ...
    private lateinit var binding:ActivityPayoutAddressDetailsBinding
    private lateinit var locationSearchBinding:LocationSearchBinding
    @Inject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPayoutAddressDetailsBinding.inflate(layoutInflater)
        locationSearchBinding = LocationSearchBinding.inflate(layoutInflater)
        setContentView(binding.root)
        binding.root.applySystemBarsPadding()
        binding.root.addView(locationSearchBinding.root)
    ...
    private fun getCountryListFromAPI(){
        if (commonMethods.isOnline(this)) {
            ...
            commonMethods.snackBar(resources.getString(R.string.network_failure), "", false, 2, payoutaddress_street, locationSearchBinding.address, resources, this)
        }
    }
