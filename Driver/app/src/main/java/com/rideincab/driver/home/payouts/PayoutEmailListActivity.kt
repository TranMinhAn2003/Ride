...
import com.rideincab.driver.common.util.Enums.REQ_CURRENCYLIST
import com.rideincab.driver.common.views.CommonActivity
import com.rideincab.driver.common.views.applySystemBarsPadding
import com.rideincab.driver.databinding.ActivityPayoutEmailListBinding
...
class PayoutEmailListActivity : CommonActivity(), View.OnClickListener, ServiceListener {
    ...
    private lateinit var binding: ActivityPayoutEmailListBinding
    @Inject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPayoutEmailListBinding.inflate(layoutInflater)
        setContentView(binding.root)
        binding.root.applySystemBarsPadding()
        AppController.getAppComponent().inject(this)
        commonMethods.imageChangeforLocality(this,binding.payoutemaillistBack)
