...
/**
 * @package com.cloneappsolutions.cabmedriver.home.splash
 * @subpackage Splash
...
import com.rideincab.driver.common.helper.Constants.FORCE_UPDATE
import com.rideincab.driver.common.helper.Constants.SKIP_UPDATE
...
import com.rideincab.driver.common.util.Enums.REG_GET_CHECK_VERSION
import com.rideincab.driver.common.util.RequestCallback
import com.rideincab.driver.common.views.CommonActivity
import com.rideincab.driver.common.views.applySystemBarsPadding
import com.rideincab.driver.databinding.ActivitySplashBinding
        ...
        try {
            ...
            when (jsonResp.requestCode) {
                REG_GET_CHECK_VERSION -> {
                    ...
                    sessionManager.checkVersionModel = jsonResp.strResponse
            ...
            Log.i("SPLASH_SCREEN" ,"onSuccess: Error=${e.localizedMessage}")
            Toast.makeText(this, "Please check your checkVersion api with responseCode=${jsonResp.responseCode}", Toast.LENGTH_SHORT).show()
        }
    }
