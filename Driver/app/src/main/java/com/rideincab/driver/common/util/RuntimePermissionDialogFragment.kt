...
import com.rideincab.driver.databinding.PopupPermissionHelperBinding
import java.util.*
...
class RuntimePermissionDialogFragment : DialogFragment() {
    lateinit var runtimePermissionBinding: PopupPermissionHelperBinding
    //    icon Lists
    ...
    val notificationIcon = R.drawable.ic_notifications_24
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        runtimePermissionBinding = PopupPermissionHelperBinding.inflate(inflater, container, false)
        isCancelable = false
        ...
        runtimePermissionBinding.tvDfPermissionNotAllow.setOnClickListener { notAllowPermission() }
        runtimePermissionBinding.tvDfPermissionAllow.setOnClickListener { allowPermission() }
        runtimePermissionBinding.root.applySystemBarsPadding()
        return runtimePermissionBinding.root
    }
    ...
    fun setImageResourceAndPermissionDescriptionForPopup() {
        ...
        runtimePermissionBinding.imgvDfPermissionImage!!.setImageResource(permissionIcon)
        runtimePermissionBinding.tvDfPermissionDescription!!.text = permissionDescription
    }
    ...
    fun getPermissionRequestedForIconAndDescription() {
        when (permissionsRequestFor!![0]) {
            ...
            BACKGROUND_LOCATION_PERMISSION -> {
                permissionIcon = locationIcon
                permissionDescription = mContext!!.resources.getString(R.string.location_permission)
            }
            ...
            POST_NOTIFICATION_PERMISSION -> {
                permissionIcon = notificationIcon
                permissionDescription = mContext!!.resources.getString(R.string.notification_permission_description)
            }
            else -> {
                permissionIcon = cameraIcon
                permissionDescription = mContext!!.resources.getString(R.string.camera_permission_description)
    ...
    private fun notAbleToRequestPermission() {
        runtimePermissionBinding.tvDfPermissionAllow!!.text = mContext!!.resources.getString(R.string.settings)
     ...
     * first add in permission list and then add icon list*/
        ...
        val POST_NOTIFICATION_PERMISSION = Manifest.permission.POST_NOTIFICATIONS
        ...
        val ANDROID13_CAMERA_PERMISSION_ARRAY = arrayOf(CAMERA_PERMISSION, READ_MEDIA_IMAGES_PERMISSION)
        val STORAGEPERMISSIONARRAY = arrayOf(WRITE_EXTERNAL_STORAGE_PERMISSION)
        val NOTIFICATIONPERMISSIONARRAY = arrayOf(POST_NOTIFICATION_PERMISSION)
        val LOCATION_PERMISSION_ARRAY = arrayOf(LOCATION_PERMISSION)
